...
<head>
    ...
    <title>CarShop | Admin Panel</title>
...
<body>
  <?php //include 'template/theme_settings.php';?>
    <div class="container" id="main-container">
        <div class="domreg">
          <h4>Please register your carshop with CarShop</h4>
          <p>You need to register you copy of carshop first with CarShop.</p>
