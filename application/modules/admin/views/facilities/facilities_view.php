    ...
    <div class="col-md-12">
        ...
        <div class="box">
            ...
            <div class="box-content">
                ...
                <a class="btn btn-primary" style="margin-bottom:15px;" href="<?php echo site_url('admin/carshop/newfacility'); ?>">Create a new amenity</a>
                                    ...
                                    <td data-title="Action" class="numeric">
                                        <div class="btn-group">
                                          ...
                                          <ul class="dropdown-menu dropdown-info">
                                              <li><a href="<?php echo site_url('admin/carshop/edit_facility/'.$row->id);?>">Edit</a></li>
                                              <li><a href="<?php echo site_url('admin/carshop/remove_facility/'.$row->id); ?>">Remove</a></li>
                                          </ul>
                                        </div>
                                    </td>
...
<script type="text/javascript">
    ...
    jQuery('document').ready(function () {
        ...
        jQuery('#remove-selected').click(function(e){
            ...
            jQuery('#all_facilities_form').attr('action','<?php echo site_url("admin/carshop/remove_bulk_facilities");?>');
