    ...
    <div class="col-md-12">
        ...
        <div class="box">
            ...
            <div class="box-content">
                                    ...
                                    <td data-title="<?php echo lang_key('actions');?>" class="numeric">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-info">
                                                ...
                                                <li><a class="detail" id="<?php echo $row->id;?>" href="<?php echo site_url('admin/carshop/editcar/'.$curr_page.'/'.$row->id);?>">Detail</a></li>
                                                <?php if(is_admin()){?>
                                                <?php }?>
                                            </ul>
                ...
                <a href="<?php echo site_url('admin/carshop/bulkemailform');?>" class="btn btn-success bulk-email">Send Bulk Email</a>
            </div>
