    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-content">
                ...
                <p>You'll have to pay <?php echo get_settings('carshop_settings','feature_charge','0').' '.get_settings('paypalsettings','currency','USD');?> and your property will be
                    Featured for <?php echo get_settings('carshop_settings','feature_day_limit','0');?> days</p>
                 <?php if(get_settings('carshop_settings','enable_paypal_transfer','Yes')=='Yes'){?>
                <?php
                ...
                <input type="hidden" name="amount" value="<?php echo get_settings('carshop_settings','feature_charge','0');?>">
                <input type="hidden" name="currency_code" value="<?php echo get_settings('paypal_settings','currency','USD');?>">
                <input type="hidden" name="no_note" value="1">
                <input type="hidden" name="no_shipping" value="1">
                <input type="hidden" name="rm" value="1">
                <input type="hidden" name="return" value="<?php echo site_url('admin/carshop/finish_url');?>">
                <input type="hidden" name="cancel_return" value="<?php echo site_url('admin/carshop/cancel_url');?>">
                ...
                <?php if(get_settings('carshop_settings','enable_bank_transfer','No')=='Yes'){?>
                <div style="border-bottom:1px solid #aaa;font-weight:bold;font-size:14px;padding:0 0 5px 5px;">Bank transfer</div>
                <?php echo get_settings('carshop_settings','featured_payment_bank_instruction','');?>                
                <?php }?>
            </div>
        </div>
    </div>
