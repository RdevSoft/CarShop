                  ...
                  <td data-title="Action" class="numeric">
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-info">
                          ...
                          <li><a href="<?php echo site_url('admin/carshop/deletecar/'.$curr_page.'/'.$row->id);?>">Delete</a></li>
                          <?php }else{?>
                          <li><a href="<?php echo site_url('admin/carshop/undo_delete/'.$curr_page.'/'.$row->id);?>">Undo Delete</a></li>
                          <?php }?>
                          <?php if(is_admin()){?>
                            <?php if($row->status==2){?>
                            <li><a href="<?php echo site_url('admin/carshop/approvecar/'.$curr_page.'/'.$row->id);?>">Approve</a></li>
                            <?php }?>
