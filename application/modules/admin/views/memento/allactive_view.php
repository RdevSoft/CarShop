                                    ...
                                    <td data-title="Options" class="numeric">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-info">
                                                ...
                                                <!--li><a href="<?php echo site_url('admin/carshop/approvepost/'.$page.'/activeposts/'.$row->id); ?>">Approve</a-->

                                                <li><a href="<?php echo site_url('admin/carshop/deletepost/'.$page.'/activeposts/'.$row->id); ?>">Delete</a>
                                                <?php if($row->featured==0){?>
                                                <li><a href="<?php echo site_url('admin/carshop/featurepost/'.$page.'/activeposts/'.$row->id); ?>">Feature</a>
                                                <?php }else{?>
                                                <li><a href="<?php echo site_url('admin/carshop/removefeaturepost/'.$page.'/activeposts/'.$row->id); ?>">Un-Feature</a>
                                                <?php }?>
                                                </li>                                                
...
<script type="text/javascript">
    ...
    jQuery('document').ready(function () {
        ...
        jQuery('#approve-selected').click(function(e){
            ...
            jQuery('#all_posts_form').attr('action','<?php echo site_url("admin/carshop/bulkapprove/activeposts");?>');
        ...
        jQuery('#delete-selected').click(function(e){
            ...
            jQuery('#all_posts_form').attr('action','<?php echo site_url("admin/carshop/bulkdelete/activeposts");?>');
