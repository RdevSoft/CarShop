<?php
...

	{
...

		{
			...
			$error .= '<div class="alert alert-error">SITE_ROOT/'.$file.' is not writable.Please change it\'s permission before installing carshop[ERROR].</div>';
...

	{
		...
		<p class="lead">Everything seems to be ok. Let's install carshop with in 2 easy step :-)</p>
