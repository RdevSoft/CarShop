$(function() {
    ...
    var t = $(".carshop-nav .dropdown-toggle > .fa-bell + .badge");
    if ($(t).length > 0 && parseInt($(t).html()) > 0) {
        $(".carshop-nav .dropdown-toggle > .fa-bell").addClass("anim-swing")
    }
    t = $(".carshop-nav .dropdown-toggle > .fa-envelope + .badge");
    if ($(t).length > 0 && parseInt($(t).html()) > 0) {
        $(".carshop-nav .dropdown-toggle > .fa-envelope").addClass("anim-top-down")
    }
